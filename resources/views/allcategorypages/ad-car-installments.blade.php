            ...
            <div class="col-md-12" id="dashboard-post">
                ...
                <div class="breadcum-box border-bottom">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Car Installments</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="main-post mt-5">
                    ...
                    <form action="" name="myForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 ad-box">
                                <label for="ad-title-input">Make *</label>
                                <input name="make" type="text" class="form-control input-field" id="ad-title-input" required>
                                <label for="ad-title-input">Mention the brand name of your item (e.g. Audi, BMW, Honda)</label>
                            </div>
                        </div>

                        <div class="row mt-4">
                            <div class="col-md-6 col-sm-12 ad-box">
                                <label for="ad-title-input">Year *</label>
                                <input name="year" type="text" class="form-control input-field" id="ad-title-input" required>
                                <label for="ad-title-input">Mention the year of your item</label>
                            </div>
                        </div>

                        <label for="radio1" class="mt-4">Condition *</label>
                        ...
                        <label for="radio1" class="mt-5">Transmission *</label>
                        <div class="condition" id="radio1">
                            <label style="margin-left: 0" class="radio-container">Automatic
                                <input type="radio" name="radio2" value="Automatic">
                                <span class="checkmark"></span>
                            </label>
                            <label class="radio-container">Manual
                                <input type="radio" name="radio2" value="Manual">
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <label for="radio1" class="mt-5">Registered *</label>
                        <div class="condition" id="radio1">
                            <label style="margin-left: 0" class="radio-container">Yes
                        ...
                        <div class="row mt-5">
                            <div class="col-md-6 col-sm-12 ad-box">
                                <label for="ad-title-input">Down Payment *</label>
                                <div class="input-group">
                                    ...
                                    <input name="downpayment" type="number" class="form-control input-field" id="ad-title-input" required>
                                </div>
                                <label for="ad-title-input">Select currency and amount (e.g. PKR 15000, AED 3600)</label>
                            </div>
                        </div>

                        <div class="row mt-4">
                            <div class="col-md-6 col-sm-12 ad-box">
                                <label for="ad-title-input">Monthly Installment *</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <select class="" id="inlineFormCustomSelect">
                                            <option value="" selected disabled></option>
                                    ...
                                    <input name="monthlyinstallment" type="number" class="form-control input-field" id="ad-title-input" required>
                                </div>
                                <label for="ad-title-input">Select currency and amount (e.g. PKR 15000, AED 3600)</label>
                            </div>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 col-sm-12 ad-box">
                                <label for="country">Installment Plan *</label>
                                <select name="installmentsplan" style="border: 1px solid #000" class="form-control" onchange="sortByCountry(this)">
                        ...
                        <label for="radio1" class="mt-4">Financer Type *</label>
                        <div class="condition" id="radio1">
                            <label style="margin-left: 0" class="radio-container">Bank
                                <input type="radio" name="radio4" value="Bank">
                                <span class="checkmark"></span>
                            </label>
                            <label class="radio-container">Non Banking Company
                                <input type="radio" name="radio4" value="Non Banking Company">
                                <span class="checkmark"></span>
                            </label>
                        </div>

                        <label for="radio1" class="mt-4">Transaction Type *</label>
                        <div class="condition" id="radio1">
                            <label style="margin-left: 0" class="radio-container">Financing
                                <input type="radio" name="radio5" value="Financing">
                                <span class="checkmark"></span>
                            </label>
                            <label class="radio-container">Leasing
                                <input type="radio" name="radio5" value="Leasing">
                                <span class="checkmark"></span>
                            </label>
                        </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6 col-sm-12 ad-box confirm-location">
