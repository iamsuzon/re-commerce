                    ...
                    <form action="" name="myForm">
                        ...
                        <div class="row mt-5">
                            <div class="col-6 ad-box">
                                ...
                                <input type="text" class="form-control input-field" id="ad-title-input" required>
                        ...
                        <div class="row mt-5">
                            <div class="col-6 ad-box">
                                ...
                                <textarea rows="4" class="form-control input-field" id="ad-description-input" required></textarea>
                        ...
                        <div class="row mt-4">
                            <div class="col-6 ad-box">
                                ...
                                <div class="input-group" id="ad-price-input">
                                    ...
                                    <input type="number" class="form-control input-field" aria-label="Amount (to the nearest dollar)" required>
                                </div>
                            ...
                            <div class="col-6 ad-box">
                                ...
                                <div class="name-img img-box mt-3">
                                    ...
                                    @endif
                                        ...
                                        <input type="text" class="form-control input-field" id="ad-name-input">

                                        <label for="ad-number-input" class="mt-2">Number *</label>
                                        <input type="number" class="form-control input-field" id="ad-number-input">
                                    </div>
                                </div>
                            </div>
                        </div>
